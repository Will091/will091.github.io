(function(){
  ...
  ready(function(){
    if(!document.querySelector('link[data-page-transition]')){
      var css=document.createElement('link');css.rel='stylesheet';css.href='page-transition.css';css.setAttribute('data-page-transition','');document.head.appendChild(css);
    }

    var layer=document.querySelector('.page-transition');
    if(!layer){
      layer=document.createElement('div');layer.className='page-transition';layer.setAttribute('aria-hidden','true');
