(function(){
  ...
  ready(function(){
    ...
    if(menu&&nav){
      ...
      menu.addEventListener('click',function(e){e.preventDefault();var open=nav.classList.toggle('open');menu.setAttribute('aria-expanded',open?'true':'false');},false);
